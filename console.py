...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, arg):
        ...
        elif "{}.{}".format(argl[0], argl[1]) not in objectsl:
            print("** no instance found **")
        else:
            print(objectsl["{}.{}".format(argl[0], argl[1])])
    ...
    def do_destroy(self, arg):
        ...
        if len(argl) == 0 or argl[0] == "":
            ...
            del objectsl["{}.{}".format(argl[0], argl[1])]
            storage.save()
    ...
    def do_all(self, arg):
        ...
        objectsl = storage.all()
        argl = arg[0:].split(' ')
        if argl[0] != "" and argl[0] not in self.__classes:
            print("** class doesn't exist **")
        else:
            objs = []
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        ...
        if len(argl) == 1:
            print("** instance id missing **")
            return False
        if "{}.{}".format(argl[0], argl[1]) not in objectsl.keys():
            print("** no instance found **")
            return False
        if len(argl) == 2:
        ...
        if len(argl) == 4:
            obj = objectsl["{}.{}".format(argl[0], argl[1])]
